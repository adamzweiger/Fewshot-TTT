...
#SBATCH --output=logs/current/icft_%A_%a.log
#SBATCH --exclude=mastiff
...
# -------------------------------------------------------------------------
EXPERIMENTS=( # 1e-5, 5e-5, 1e-4; 64, 128; 16, 32, 64, 128; 5; 1; 40, 60, 80; True; False; False; 42
  "exp 1e-4 64 64 5 1 40 True False False 42"
  "exp 1e-4 64 64 5 1 40 True False False 43"
  "exp 1e-4 64 64 5 1 40 True False False 44"
  "exp 1e-4 64 64 5 1 40 True False False 45"
  "exp 1e-4 64 64 5 1 40 True False False 46"
)
...
EXP_NAME="ICFT_${EXP_NOTE}_${K_SHOT}_${DATASET_TYPE}_${NUM_TRAINING_STEPS}_${SHUFFLE}_${MAJORITY_VOTE}_${VOTE_PERMUTATIONS}_${LEAVE_ONE_OUT}_${BATCH_SIZE}_${EPOCHS}_${LR}_${LORA_RANK}_${LORA_ALPHA}_${LORA_DROPOUT}_${SEED_NUM}"
